...
sys.path.append("/root/repo/pytorch-3dunet/")
...
class AbstractUNet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, basic_module, f_maps=64, layer_order='gcr',
        ...
        if isinstance(f_maps, int):
            #[init_channel_number * 2 ** k for k in range(num_levels)]
    ...
    def forward(self, x):
        # encoder part
        encoders_features = []
    #     if input is given shape (1,3,52,128),
    #     then shape would be 
    #     torch.Size([1, 64, 52, 128, 128])
    #  torch.Size([1, 128, 26, 64, 64])    
    #  torch.Size([1, 256, 13, 32, 32])
    #  torch.Size([1, 512, 6, 16, 16])
        ...
        # before cut
        # [torch.Size([1, 512, 6, 16, 16]), torch.Size([1, 256, 13, 32, 32]), torch.Size([1, 128, 26, 64, 64]), torch.Size([1, 64, 52, 128, 128])]
        
        #need to cut because last encoder is also x at the momment
        encoders_features = encoders_features[1:]
        #after  [torch.Size([1, 256, 13, 32, 32]), torch.Size([1, 128, 26, 64, 64]), torch.Size([1, 64, 52, 128, 128])]
...
if __name__=="__main__":
    net =UNet3D(3,5).to("cuda")
    x=torch.rand(1,3,52,128,128).to("cuda")
    y=net(x)
