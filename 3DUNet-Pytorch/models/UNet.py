...
class UNet(nn.Module):
    ...
    def forward(self, x):
       ...
       # t4 = out
        ...
        ## haha, it use 4 out put
        output1 = self.map1(out)
        # print ("de1",output1.shape) (3,16,16) * scale_factor=(16, 32, 32)= 48,512,512
        out = F.relu(F.interpolate(self.decoder2(out),scale_factor=(2,2,2),mode ='trilinear'))
        # print ("de2",out.shape)  (2, 128, 6, 32, 32], this is add operation, not concat
