...
parser.add_argument('--dataset_path',default = '/root/data/liver/fix_train',help='fixed trainset root path')
parser.add_argument('--test_data_path',default = '/root/data/liver/train',help='Testset path')
